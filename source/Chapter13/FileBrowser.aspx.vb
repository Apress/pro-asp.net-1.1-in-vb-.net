...
'			Me.gridDirList.ItemCommand += New System.Web.UI.WebControls.DataGridCommandEventHandler(Me.gridDirList_ItemCommand);
'			Me.gridFileList.SelectedIndexChanged += New System.EventHandler(Me.gridFileList_SelectedIndexChanged);
'			Me.cmdUp.Click += New System.EventHandler(Me.cmdUp_Click);
'			Me.Load += New System.EventHandler(Me.Page_Load);
    ...
    End Sub
    Private Sub Dummy()
      Dim uriString As String = "http://www.wrongsite.com/page.aspx?cmd=run"
      Dim uriThis As New Uri(uriString)
      Dim page As String = System.IO.Path.GetFileName(uriThis.AbsolutePath)
      Dim baseUri As New uri("http://www.rightsite.com")
      uriThis = New Uri(baseUri, page)
      ' uriThis now stores the path 'http://www.rightside.com/page.aspx'
