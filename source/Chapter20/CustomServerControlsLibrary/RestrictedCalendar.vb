...
Namespace CustomServerControlsLibrary
 ...
 Public Class RestrictedCalendar
        ...
        Public Property AllowWeekendSelection() As Boolean
            Get
                Return CType(ViewState("AllowWeekendSelection"), Boolean)
            End Get
    ...
    Public Class DateTimeCollection : Inherits CollectionBase
        Default Public Property Item(ByVal index As Integer) As DateTime
            Get
    ...
    Public Class RestrictedCalendarDesigner : Inherits ControlDesigner
        Public Overrides Function GetPersistInnerHtml() As String
            ...
            Dim ctlCalendar As RestrictedCalendar = IIf(TypeOf Me.Component Is RestrictedCalendar, CType(Me.Component, RestrictedCalendar), CType(Nothing, RestrictedCalendar))
            If Not ctlCalendar Is Nothing Then
                ...
                ' in the format:
                '   <Color value='xxx' />
                For Each dteDate As DateTime In ctlCalendar.NonSelectableDates
