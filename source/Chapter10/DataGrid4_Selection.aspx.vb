...
Namespace Chapter10
	...
	''' </summary>
	Public Class DataGrid4 : Inherits System.Web.UI.Page
...
'			Me.Datagrid1.SelectedIndexChanged += New System.EventHandler(Me.Datagrid1_SelectedIndexChanged);
'			Me.Load += New System.EventHandler(Me.Page_Load);
		...
		Private Sub Datagrid1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Datagrid1.SelectedIndexChanged
			...
			Dim empID As Integer = CInt(Datagrid1.DataKeys(Datagrid1.SelectedIndex))
